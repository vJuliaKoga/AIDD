# PRM-REQ-YAML-002 — 要件定義 YAML 生成プロンプト

> prompt_id: PRM-REQ-YAML-002
> phase: REQ（要件定義フェーズ）
...
```
対象企画書 YAML ディレクトリ: AIDD/planning/yaml/planningv2.2/
...
セクション番号 01（エグゼクティブサマリー / Executive Summary）

- 理由: プロジェクト全体の要約であり、個別要件として定義する内容を含まない

セクション番号 16（付録 / Appendix）
